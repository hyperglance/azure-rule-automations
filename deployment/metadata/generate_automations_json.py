...
if __name__ == '__main__':
  ...
  lambda_root = pathlib.Path(os.path.abspath(__file__)).parents[2].joinpath('hyperglance_automations') 
  sys.path.append(str(lambda_root))
  with open(automations_file, "w") as automations_file:
    automations_file.write(generate_json(lambda_root))
